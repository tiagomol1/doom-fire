...
function renderFire(){
    let html = `<table cellspacing = 0 cellpading = 0>`;
...
function createFireSource(){
    for (let column = 0; column < fireWidth; column++) {
        ...
        firePixelsArray[pixelIndex] = initialIntesity
    }
}
...
function minusFire(){
    initialIntesity = initialIntesity - 4 >= 0 ? initialIntesity - 4 : 0
...
function moreFire(){
    initialIntesity = initialIntesity + 4 <= 36 ? initialIntesity + 4 : 36
